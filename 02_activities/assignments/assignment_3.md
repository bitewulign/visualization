...
Public health experts can use this visualization to track vaccination coverage and identify gaps.
General citizens can better understand vaccine distribution and coverage rates.
    
    > How did you choose which features of your chosen dataset to include or exclude from your visualization? 
    🔎 **Feature selection:**
I included the four key vaccination stages (at least one dose, partially vaccinated, fully vaccinated, and third doses) as they represent the most meaningful vaccine coverage categories.
I excluded columns like daily doses administered, which are more relevant for time-series visualizations rather than pie charts.
